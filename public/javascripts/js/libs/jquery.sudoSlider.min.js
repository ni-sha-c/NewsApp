...
i(a).load(function(){e(a)}).error(function(){e(a)});if("complete"==a.readyState)i(a).trigger("load");else if(a.readyState)a.src=a.src;else if(a.complete)i(a).trigger("load");else if(void 0===a.complete){var d=a.src;a.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";a.src=d}})}function Y(d,b){a[19]&&ra(d,b,e);a[39]&&ra(d,b,c)}function ra(a,b,e){S.ready(function(){sa(a,b,e);ca(m.eq(a),c,function(){sa(a,b,e)})})}function sa(d,b,e){d=t(d);l=m.eq(d)[e?"height":"width"]();S.animate(e?
